<template>
  <div class="overlayer-app-container">
    <!-- Beautiful Ambient Glowing Background -->
    ...
    <div class="showcase-wrapper">
      ...
      <header class="showcase-header">
        <NuxtLink to="/" class="header-left">
          <div class="logo-wrap">
            <svg class="logo-img-main" viewBox="0 0 300 291" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span class="main-title">modlist.org</span>
        </NuxtLink>
        ...
        <div class="header-right">
          <nav class="nav-links">
            ...
            <NuxtLink v-if="user" to="/pending" class="nav-link" active-class="active" style="display: flex; align-items: center; gap: 6px;">
              {{ t('nav.pending_mods') }}
            ...
            <a href="https://github.com/modlist-org/modlist_org_app/releases/latest" target="_blank" class="nav-link app-download-header-link" style="display: flex; align-items: center; gap: 6px;">
              <svg class="download-icon-svg" style="width: 16px; height: 16px; fill: none; stroke: currentColor; stroke-width: 2; margin-bottom: 0;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://discord.modlist.org" target="_blank" class="nav-link discord-header-link" style="display: flex; align-items: center; gap: 6px;">
              <svg class="discord-icon-svg" style="width: 16px; height: 16px; fill: currentColor; margin-bottom: 0;" viewBox="0 0 127.14 96.36" xmlns="http://www.w3.org/2000/svg">
      ...
      <footer class="showcase-footer">
        <div class="footer-left">
          <span>&copy; {{ new Date().getFullYear() }} modlist.org. All rights reserved.</span>
        </div>
        <div class="footer-right">
          <NuxtLink to="/privacy" class="footer-link">{{ t('nav.privacy') }}</NuxtLink>
          <NuxtLink to="/terms" class="footer-link">{{ t('nav.terms') }}</NuxtLink>
